...
(function ($, undefined) {
    ...
    var gbDefaults = {
        ...
        guestbookTemplate: '../Controls/Guestbook/Templates/ADNWGuestbook.htm',
        guestbookEntryTemplate: '../Controls/Guestbook/Templates/GuestbookEntry.htm'
    }
    ...
    $.fn.Guestbook = function (opts) {
        ...
        if (options.Id != undefined && options.Id != '') {
            options.url = options.url +                                                 //URL
                            options.clientApp +                                         //Entity Root
                            "(guid'" + options.Id + "')?" +                             //Entity Id
                            options.returnType +                                        //Return Data Type
                            ((options.entity) ? '&$expand=' + options.entity : '');     //Return Object Type
        }
    ...
    function LoadGuestbookEntries(guestbookSource) {
        var entries = [];
